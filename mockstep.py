...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Simulate walking steps on an Android emulator and display a live graph."
    )
    parser.add_argument(
        "--port",
        type=int,
    ...
    parser.add_argument(
        ...
        default="medium",
        help="Preset display size (default: medium). Individual dimension args override preset values.",  # noqa: E501
    )
    parser.add_argument(
        "--bar-width",
        type=int,
